"""
1223회만 step 33~200 backfill (1222회는 나중에)
"""
...
BATCH_SIZE = 30  # 30 step씩 커밋 (속도 개선)

def main():
    print("=" * 80)
    print("1223회 회귀 분석 backfill (step 33~200)")
    print("=" * 80)
    ...
    while current_step <= 200:
        ...
        for step in range(current_step, batch_end + 1):
            try:
                reg_result = ensemble.predict_regression(history_1223, step=step)
