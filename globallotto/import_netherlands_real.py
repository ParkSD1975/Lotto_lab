"""Netherlands Lotto 실제 데이터 → Supabase import"""
import csv, os
...
LOTTERY_NAME = "Netherlands Lotto"
BATCH_SIZE = 100
...
def main():
    ...
    batch, inserted = [], 0
    with open(os.path.join(BASE_DIR, "Netherlands_Lotto_real.csv"), encoding="utf-8-sig") as f:
