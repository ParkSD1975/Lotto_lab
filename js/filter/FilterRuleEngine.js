...
(function () {
    ...
    // ── 모든 기초 필터 표준 키 목록 (DB filter_definitions.filter_key 와 1:1 일치) ────
    // ⚠ 키 추가/변경 시 반드시 4계층(프론트·백엔드·DB filter_definitions·DB 컬럼/weekly_filter_predictions) 동시 갱신
    const FILTER_KEYS = [
        'ac_value',
        'total_sum',
        'tail_sum',
        // [2026-05-15] 끝수 0~9 개별 독립 필터 (통합 tail_digit_patterns 폐기)
        'end_digit_0_count',
        'end_digit_1_count',
        'end_digit_2_count',
        'end_digit_3_count',
